...
3. Rechnen: `cli.py frist_berechnen start=JJJJ-MM-TT menge=… einheit=tage|wochen|monate|jahre ereignisfrist=true werktagsregel=true`.
   Die Rechnung wörtlich übernehmen. Ob § 193 BGB (Verschiebung auf den
   nächsten Werktag) auf diese Frist anwendbar ist, gesondert prüfen und im
   Text sagen; bei Zweifel den rechnerischen Tag als sicheren Tag nennen.
