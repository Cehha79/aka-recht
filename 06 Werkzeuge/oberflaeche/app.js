...
document.addEventListener('submit', async e => {
  if (e.target.id === 'einstellungen') {
    ...
    const daten = {sicherung: {ziel: f.get('ziel').trim(), zweites_ziel: f.get('zweites_ziel').trim()}};
