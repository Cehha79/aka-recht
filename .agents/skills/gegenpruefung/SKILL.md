...
<!-- Erzeugt von „06 Werkzeuge/verteilen.py“ aus .claude/skills/gegenpruefung/SKILL.md.
     Nicht von Hand ändern: die Quelle pflegen, dann das Skript laufen lassen. -->

# Gegenprüfung für $fall: $ziel

Lies `AGENTS.md`, die Akte (`cli.py fall_lesen fall=$fall`) und den zu prüfenden
