...
<!-- Erzeugt von „06 Werkzeuge/verteilen.py“ aus .claude/skills/sachverhalt/SKILL.md.
     Nicht von Hand ändern: die Quelle pflegen, dann das Skript laufen lassen. -->

# Sachverhalt und Belege für $fall

Lies `AGENTS.md`. Akte lesen mit `python3 "06 Werkzeuge/dienst/cli.py" fall_lesen fall=$fall`.
